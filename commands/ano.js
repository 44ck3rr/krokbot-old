...
module.exports.run = async (client, message, args) => {
    if (!message.channel.id === "872591585525780530") return 
        message.delete();
        message.channel.send('Cette commande est utilisable seulement sur La Taverne des Autistes dans le salon <#872591585525780530>')
